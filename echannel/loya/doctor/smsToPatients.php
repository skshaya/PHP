...
<html>
    ...
    <body>
        ...
        if (isset($_POST['sendotp'])) {
            ...
            $message = "Hello ".$_POST['name']." ".$_POST['msg']." ".$otp;
        ...
        <div class="w3-display-container w3-content img-responsive"  style="max-width:1500px; height:500px">
            ...
            <div class="w3-display-container" style="padding-left:418px; ">    
                <br><br><br><br><br>
                <form role='form' method="post" enctype="multipart/form-data" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin " style="width:500px;">
                    <h2 class="w3-center">Send Medical Suggestion to the patient </h2>
                    <div class="w3-row w3-section">
                        <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user-md"></i></div>
                        <div class="w3-rest">
                            <input class="form-control" id="name" name="id" placeholder="Pateint's Id" type="text"/>
                        </div>
                    </div>
                    <div class="w3-row w3-section">
                        <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user-md"></i></div>
                        <div class="w3-rest">
                            <input class="form-control" id="name" name="name" placeholder="Pateint's Name" type="text"/>
                        </div>
                    </div>
                    <div class="w3-row w3-section">
                        <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-mobile"></i></div>
                        <div class="w3-rest">
                            <input class="form-control" id="mobile" name="mobile" placeholder="Phone Number" type="text"/>
                        </div>
                    </div>
                    <div class="w3-row w3-section">
                        <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-pills"></i></div>
                        <div class="w3-rest">
                            <textarea class="form-control" id="spec" name="msg" placeholder="Enter Message Here" type="text"/> </textarea>                       </div>
                    </div>
                    <button type="button" name="sendotp" class="w3-btn w3-block w3-section w3-blue w3-ripple w3-padding" >Send OTP</button>
                </form>
            </div>
        </div>
    </div>
