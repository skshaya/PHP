...
<div class="w3-dropdown-hover w3-hide-small w3-hide-small w3-right">
      ...
      <button class=" w3-button"><i class="fas fa-user-circle fa-2x "></i>&nbsp; Thulki Vimarsha <i class="fa fa-caret-down"></i></button>     
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="#" class="w3-bar-item w3-button">Update Password</a>
