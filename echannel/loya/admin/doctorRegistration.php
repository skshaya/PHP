...
// Check connection
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            $sql = "INSERT INTO doctor (docName,address,speciality,NIC,telNo,hospital,email,telHome) VALUES ('" . $firstName . " " . $lastName . "','" . $addressLine1 . " " . $addressLine2 . " " . $city . "','" . $specialty . "','" . $NIC . "',' $telNo','" . $baseHospital . "','" . $email . "','$telHome')";
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                if (!mysqli_query($conn, $sql2)) {
                    ...
                    <div class="alert alert-danger" role="alert">
                        <strong>Successfully Inserted</strong>&nbsp;<a href="admin.php.php">Back to Home</a>
                    </div>
                    <?php
                }
            }
